...
public class CarsController : Controller
{
    ...
    public async Task<IActionResult> Create([Bind("CarId,VIN,Year,MakeId,ModelId,Trim,PurchaseDate,PurchasePrice,AvailabilityDate,SaleDate,SalePrice,IsAvailable,PhotoPath,Description,RepairCost")] Car car, IFormFile photo)
    {
